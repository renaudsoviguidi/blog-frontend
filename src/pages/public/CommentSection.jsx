                    ...
                    {comment.replies.map(reply => (
                        <div key={reply.ref} style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '.5rem' }}>
                                ...
                                <p style={{ fontSize: '.82rem', fontWeight: 600, color: '#1e293b', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                    {reply.author?.name ?? 'Anonyme'}
                                </p>
                                <p style={{ fontSize: '.7rem', color: '#94a3b8', fontFamily: "'Plus Jakarta Sans', sans-serif", marginLeft: 'auto' }}>
                                    {reply.created_at
                            ...
                            <p style={{ fontSize: '.85rem', color: '#475569', lineHeight: 1.6, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                {reply.content}
                            </p>
                        </div>
                    ))}
